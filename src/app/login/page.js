  ...
  return (
    <div className='flex justify-center items-center min-h-screen p-4'>
      <div className='w-full max-w-md p-8 space-y-6 bg-slate-800/50 rounded-lg shadow-lg'>
        ...
        <button type="button" onClick={handleGoogleLogin} className='w-full py-2 flex items-center justify-center gap-x-2 text-white bg-red-600 rounded-md hover:bg-red-700' disabled={true}>Sign in with Google Currently disabled</button>
